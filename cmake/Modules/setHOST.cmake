macro( setHOST )
  ...
  string(REGEX MATCH "clogin[0-9][0-9]" HOST-WCOSS2 ${HOSTNAME} )
  if( NOT HOST-WCOSS2 ) # don't overwrite if on cactus
    string(REGEX MATCH "dlogin[0-9][0-9]" HOST-WCOSS2 ${HOSTNAME} )
  endif()
